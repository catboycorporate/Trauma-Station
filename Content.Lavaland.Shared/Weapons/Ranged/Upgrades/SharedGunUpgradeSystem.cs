...
using Content.Lavaland.Shared.Weapons.Ranged.Upgrades.Components;
...
namespace Content.Lavaland.Shared.Weapons.Ranged.Upgrades;
...
public abstract class SharedGunUpgradeSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_cfg, LavalandCVars.AllowDuplicatePkaModules, x => _allowDupes = x, true);
    }
    ...
    private void OnItemSlotInsertAttemptEvent(Entity<UpgradeableGunComponent> ent, ref ItemSlotInsertAttemptEvent args)
    {
        ...
        // don't check if dupe upgrades are allowed or this is a non-unique upgrade
        if (_allowDupes || !upgradeComp.Unique)
            return;
