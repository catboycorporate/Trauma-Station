...
/// <summary>
/// Trauma - like the others but raised on the injector item.
/// </summary>
[ByRefEvent]
public sealed class InjectorBeforeInjectEvent(EntityUid user, EntityUid usedInjector, EntityUid target, string? overrideMessage = null)
    : BeforeInjectTargetEvent(user, usedInjector, target, overrideMessage);
